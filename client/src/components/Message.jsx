    ...
    <div>
      {message.role === "user" ? (
        <div className="flex items-start justify-end my-2 sm:my-4 gap-1 sm:gap-2">
          <div className="flex flex-col gap-1 sm:gap-2 p-2 sm:p-3 px-2 sm:px-4 bg-slate-50 dark:bg-[#57317C]/30 border border-[#80609F]/30 rounded-lg max-w-[95vw] sm:max-w-2xl">
        ...
        <div className="flex flex-col gap-1 sm:gap-2 p-2 sm:p-3 px-2 sm:px-4 max-w-[95vw] sm:max-w-2xl bg-primary/20 dark:bg-[#57317C]/30 border border-[#80609F]/30 rounded-lg my-2 sm:my-4">
          {message.isImage ? (
            <img
              src={message.content}
